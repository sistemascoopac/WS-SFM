...
class Funciones {
    ...
    public static $DIRECCION_WEB_SERVICE = "https://cooperativasfm.azurewebsites.net/webservice";
   public static $DIRECCION_WEB_SERVICE_FOTOS="https://cooperativasfm.azurewebsites.net/";
